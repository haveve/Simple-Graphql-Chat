...
export default function MultiControl(props: { value?: string, size?: 'w-25' | 'w-50' | 'w-100', placeHolder?: string, className?: string, SendMessage: (createdMessage: string, setCreatedMessage: React.Dispatch<string>) => void }) {
    const { SendMessage, size, placeHolder, className, value } = props;
